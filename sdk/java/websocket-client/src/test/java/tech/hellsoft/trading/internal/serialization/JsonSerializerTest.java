...
class JsonSerializerTest {
  ...
  void shouldThrowExceptionForInvalidJsonDeserialization(String json) {
    assertThrows(
        IllegalArgumentException.class, () -> JsonSerializer.fromJson(json, OrderMessage.class));
  }

  @Test
  void shouldThrowExceptionForNullClass() {
    assertThrows(IllegalArgumentException.class, () -> JsonSerializer.fromJson("{}", null));
  }
  ...
  void shouldThrowExceptionForInvalidJsonParsing(String json) {
    assertThrows(IllegalArgumentException.class, () -> JsonSerializer.parseObject(json));
  }
  ...
  void shouldThrowExceptionForNullType() {
    assertThrows(IllegalArgumentException.class, () -> JsonSerializer.fromJson("{}", (Type) null));
  }
  ...
  void shouldThrowExceptionForInvalidJsonWithType(String json) {
    ...
    assertThrows(IllegalArgumentException.class, () -> JsonSerializer.fromJson(json, listType));
  }
  ...
  void shouldThrowExceptionForMalformedJsonWithType() {
    ...
    assertThrows(RuntimeException.class, () -> JsonSerializer.fromJson("{invalid json}", listType));
  }

  @Test
  void shouldSerializeNullFieldsInObject() {
    OrderMessage order =
        OrderMessage.builder().type(MessageType.ORDER).clOrdID("ORDER-123").build();
  ...
  void shouldThrowExceptionForMalformedJson() {
    ...
    assertThrows(
        RuntimeException.class, () -> JsonSerializer.fromJson(malformedJson, OrderMessage.class));
  }
  ...
  void shouldThrowExceptionForMalformedJsonObject() {
    ...
    assertThrows(RuntimeException.class, () -> JsonSerializer.parseObject(malformedJson));
  }
