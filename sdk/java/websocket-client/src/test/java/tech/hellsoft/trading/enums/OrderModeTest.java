...
class OrderModeTest {
  ...
  void shouldThrowExceptionForInvalidMode() {
    assertThrows(IllegalArgumentException.class, () -> OrderMode.fromJson("INVALID"));
  }

  @Test
  void shouldThrowExceptionForNullMode() {
    assertThrows(IllegalArgumentException.class, () -> OrderMode.fromJson(null));
  }

  @Test
  void shouldThrowExceptionForEmptyMode() {
    assertThrows(IllegalArgumentException.class, () -> OrderMode.fromJson(""));
  }
