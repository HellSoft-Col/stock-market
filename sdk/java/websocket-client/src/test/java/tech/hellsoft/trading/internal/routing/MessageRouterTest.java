...
class MessageRouterTest {
  ...
  void shouldRouteLoginOKMessage() {
    String json =
        "{\"type\":\"LOGIN_OK\",\"team\":\"TestTeam\",\"species\":\"TestSpecies\",\"initial_balance\":10000.0}";
  ...
  void shouldRouteFillMessage() {
    String json =
        "{\"type\":\"FILL\",\"cl_ord_id\":\"ORDER-123\",\"fill_qty\":10,\"fill_price\":100.5,\"side\":\"BUY\",\"product\":\"GUACA\"}";
  ...
  void shouldRouteOfferMessage() {
    String json =
        "{\"type\":\"OFFER\",\"offer_id\":\"OFFER-123\",\"buyer\":\"BuyerTeam\",\"product\":\"SEBO\",\"quantity_requested\":50}";
  ...
  void shouldRouteErrorMessage() {
    String json =
        "{\"type\":\"ERROR\",\"code\":\"INVALID_ORDER\",\"reason\":\"Order validation failed\"}";
  ...
  void shouldRouteInventoryUpdateMessage() {
    ...
    ArgumentCaptor<InventoryUpdateMessage> captor =
        ArgumentCaptor.forClass(InventoryUpdateMessage.class);
  ...
  void shouldRouteBalanceUpdateMessage() {
    ...
    ArgumentCaptor<BalanceUpdateMessage> captor =
        ArgumentCaptor.forClass(BalanceUpdateMessage.class);
  ...
  void shouldRouteBroadcastNotificationMessage() {
    String json =
        "{\"type\":\"BROADCAST_NOTIFICATION\",\"message\":\"Market closing soon\",\"sender\":\"SYSTEM\"}";

    router.routeMessage(json, handlers);

    ArgumentCaptor<BroadcastNotificationMessage> captor =
        ArgumentCaptor.forClass(BroadcastNotificationMessage.class);
  ...
  void shouldHandleNullHandlersGracefully() {
    ...
    assertDoesNotThrow(() -> router.routeMessage(json, null));
  }

  @Test
  void shouldHandleComplexNestedJson() {
    String json =
        "{\"type\":\"LOGIN_OK\",\"team\":\"TestTeam\",\"species\":\"TestSpecies\","
