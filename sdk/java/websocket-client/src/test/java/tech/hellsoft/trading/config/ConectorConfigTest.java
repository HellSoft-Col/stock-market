...
class ConectorConfigTest {
  ...
  void shouldAllowDisablingAutoReconnect() {
    ConectorConfig config = ConectorConfig.builder().autoReconnect(false).build();
  ...
  void shouldAllowDisablingMessageSequencing() {
    ConectorConfig config = ConectorConfig.builder().enableMessageSequencing(false).build();
  ...
  void shouldAllowDisablingStateLocking() {
    ConectorConfig config = ConectorConfig.builder().enableStateLocking(false).build();
  ...
  void shouldAllowDisablingAutoResync() {
    ConectorConfig config = ConectorConfig.builder().autoResyncOnReconnect(false).build();
