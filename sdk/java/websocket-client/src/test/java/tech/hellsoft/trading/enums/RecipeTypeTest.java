...
class RecipeTypeTest {
  ...
  void shouldThrowExceptionForInvalidType() {
    assertThrows(IllegalArgumentException.class, () -> RecipeType.fromJson("INVALID"));
  }

  @Test
  void shouldThrowExceptionForNullType() {
    assertThrows(IllegalArgumentException.class, () -> RecipeType.fromJson(null));
  }

  @Test
  void shouldThrowExceptionForEmptyType() {
    assertThrows(IllegalArgumentException.class, () -> RecipeType.fromJson(""));
  }
