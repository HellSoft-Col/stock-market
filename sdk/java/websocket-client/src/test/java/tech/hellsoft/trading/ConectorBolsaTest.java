...
class ConectorBolsaTest {
  ...
  void shouldThrowExceptionWhenConfigIsNull() {
    assertThrows(IllegalArgumentException.class, () -> new ConectorBolsa(null));
  }
  ...
  void shouldThrowExceptionWhenAddingNullListener() {
    assertThrows(IllegalArgumentException.class, () -> connector.addListener(null));
  }
  ...
  void shouldThrowExceptionWhenConnectingWithNullHost() {
    assertThrows(
        IllegalArgumentException.class, () -> connector.conectar(null, 8080, "test-token"));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithEmptyHost() {
    assertThrows(IllegalArgumentException.class, () -> connector.conectar("", 8080, "test-token"));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithBlankHost() {
    assertThrows(
        IllegalArgumentException.class, () -> connector.conectar("   ", 8080, "test-token"));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithInvalidPortZero() {
    assertThrows(
        IllegalArgumentException.class, () -> connector.conectar("localhost", 0, "test-token"));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithInvalidPortNegative() {
    assertThrows(
        IllegalArgumentException.class, () -> connector.conectar("localhost", -1, "test-token"));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithInvalidPortTooHigh() {
    assertThrows(
        IllegalArgumentException.class, () -> connector.conectar("localhost", 65536, "test-token"));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithNullToken() {
    assertThrows(IllegalArgumentException.class, () -> connector.conectar("localhost", 8080, null));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithEmptyToken() {
    assertThrows(IllegalArgumentException.class, () -> connector.conectar("localhost", 8080, ""));
  }

  @Test
  void shouldThrowExceptionWhenConnectingWithBlankToken() {
    assertThrows(
        IllegalArgumentException.class, () -> connector.conectar("localhost", 8080, "   "));
  }
  ...
  void shouldThrowExceptionWhenSendingLoginWhileNotConnected() {
    assertThrows(IllegalStateException.class, () -> connector.enviarLogin("test-token"));
  }

  @Test
  void shouldThrowExceptionWhenSendingLoginWithNullToken() {
    assertThrows(IllegalStateException.class, () -> connector.enviarLogin(null));
  }

  @Test
  void shouldThrowExceptionWhenSendingLoginWithEmptyToken() {
    assertThrows(IllegalStateException.class, () -> connector.enviarLogin(""));
  }
  ...
  void shouldThrowExceptionWhenSendingOrderWhileNotAuthenticated() {
    ...
    assertThrows(IllegalStateException.class, () -> connector.enviarOrden(order));
  }
  ...
  void shouldThrowExceptionWhenSendingCancelWhileNotAuthenticated() {
    assertThrows(IllegalStateException.class, () -> connector.enviarCancelacion("order-1"));
  }
  ...
  void shouldThrowExceptionWhenSendingProductionUpdateWhileNotAuthenticated() {
    ProductionUpdateMessage update =
        ProductionUpdateMessage.builder().product(Product.GUACA).quantity(5).build();

    assertThrows(
        IllegalStateException.class, () -> connector.enviarActualizacionProduccion(update));
  }
  ...
  void shouldThrowExceptionWhenSendingOfferResponseWhileNotAuthenticated() {
    AcceptOfferMessage response =
        AcceptOfferMessage.builder().offerId("offer-1").accept(true).build();

    assertThrows(IllegalStateException.class, () -> connector.enviarRespuestaOferta(response));
  }
