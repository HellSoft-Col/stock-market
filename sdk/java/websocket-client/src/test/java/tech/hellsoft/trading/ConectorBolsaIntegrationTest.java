...
class ConectorBolsaIntegrationTest {
    ...
    void shouldNotifyListenersOnLoginOk() throws Exception {
        ...
        LoginOKMessage loginOk = LoginOKMessage.builder()
    ...
    void shouldNotifyListenersOnOrderAck() throws Exception {
        ...
        OrderAckMessage ack = OrderAckMessage.builder()
    ...
    void shouldNotifyListenersOnInventoryUpdate() throws Exception {
        ...
        InventoryUpdateMessage inventoryUpdate = InventoryUpdateMessage.builder()
    ...
    void shouldNotifyListenersOnBalanceUpdate() throws Exception {
        ...
        BalanceUpdateMessage balanceUpdate = BalanceUpdateMessage.builder()
    ...
    void shouldNotifyListenersOnEventDelta() throws Exception {
        ...
        EventDeltaMessage eventDelta = EventDeltaMessage.builder()
    ...
    void shouldNotifyListenersOnBroadcast() throws Exception {
        ...
        BroadcastNotificationMessage broadcast = BroadcastNotificationMessage.builder()
    ...
    void shouldHandleListenerExceptionGracefully() throws Exception {
        ...
        EventListener goodListener = new TestListener() {
            @Override
            public void onError(ErrorMessage message) {
        ...
        assertTrue(latch.await(2, TimeUnit.SECONDS), "Good listener should be called despite exception");
    ...
    void shouldHandlePongMessageWhenHeartbeatManagerExists() throws Exception {
        ...
        assertDoesNotThrow(() -> invokePrivateMethod(connector, "onMessageReceived", String.class, json));
    }
    ...
    private void invokePrivateMethod(Object target, String methodName, Class<?> paramType, Object param) throws Exception {
