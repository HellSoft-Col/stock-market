...
class MessageTypeTest {
  ...
  void shouldThrowExceptionForInvalidValue() {
    assertThrows(IllegalArgumentException.class, () -> MessageType.fromJson("INVALID_TYPE"));
  }

  @Test
  void shouldThrowExceptionForNullValue() {
    assertThrows(IllegalArgumentException.class, () -> MessageType.fromJson(null));
  }

  @Test
  void shouldHaveAllValuesUnique() {
    long uniqueCount =
        Stream.of(MessageType.values()).map(MessageType::getValue).distinct().count();
