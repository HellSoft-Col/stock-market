...
class OrderSideTest {
  ...
  void shouldThrowExceptionForInvalidSide() {
    assertThrows(IllegalArgumentException.class, () -> OrderSide.fromJson("INVALID"));
  }

  @Test
  void shouldThrowExceptionForNullSide() {
    assertThrows(IllegalArgumentException.class, () -> OrderSide.fromJson(null));
  }

  @Test
  void shouldThrowExceptionForEmptySide() {
    assertThrows(IllegalArgumentException.class, () -> OrderSide.fromJson(""));
  }
