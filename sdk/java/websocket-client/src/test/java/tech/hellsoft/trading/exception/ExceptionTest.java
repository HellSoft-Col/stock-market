...
class ExceptionTest {
  ...
  void shouldCreateConexionFallidaException() {
    ConexionFallidaException ex =
        new ConexionFallidaException("Connection failed", "localhost", 8080);
  ...
  void shouldCreateConexionFallidaExceptionWithCause() {
    ...
    ConexionFallidaException ex =
        new ConexionFallidaException("Connection failed", "localhost", 8080, cause);
